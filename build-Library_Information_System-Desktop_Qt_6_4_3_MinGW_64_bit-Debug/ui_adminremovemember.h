/********************************************************************************
** Form generated from reading UI file 'adminremovemember.ui'
**
...
#ifndef UI_ADMINREMOVEMEMBER_H
#define UI_ADMINREMOVEMEMBER_H
...
public:
    ...
    void setupUi(QDialog *AdminRemoveMember)
    {
        if (AdminRemoveMember->objectName().isEmpty())
            AdminRemoveMember->setObjectName("AdminRemoveMember");
        AdminRemoveMember->resize(1019, 670);
        frame = new QFrame(AdminRemoveMember);
...
"border-radius: 5px;\n"
"background: rgb(235, 235, 235);"));
        lisNum = new QLineEdit(frame_9);
        lisNum->setObjectName("lisNum");
        lisNum->setGeometry(QRect(0, 240, 531, 31));
        lisNum->setStyleSheet(QString::fromUtf8("border: 0.5px solid black;\n"
"border-radius: 5px;\n"
"background: rgb(235, 235, 235);"));
...
"font-weight: bold;"));
        ...
        pushButton->setGeometry(QRect(0, 320, 201, 29));
...
"}"));
        ...
        retranslateUi(AdminRemoveMember);

        QMetaObject::connectSlotsByName(AdminRemoveMember);
    } // setupUi

    void retranslateUi(QDialog *AdminRemoveMember)
    {
        AdminRemoveMember->setWindowTitle(QCoreApplication::translate("AdminRemoveMember", "Dialog", nullptr));
        menuPanel->setTitle(QString());
        logo->setText(QString());
        plainTextEdit_6->setPlainText(QCoreApplication::translate("AdminRemoveMember", "Admin Menu", nullptr));
        label_5->setText(QString());
        catalogue->setText(QCoreApplication::translate("AdminRemoveMember", "Catalogue", nullptr));
        label_6->setText(QString());
        manageBooks->setText(QCoreApplication::translate("AdminRemoveMember", "Manage Books", nullptr));
        label_7->setText(QString());
        status->setText(QCoreApplication::translate("AdminRemoveMember", "View Status", nullptr));
        label_8->setText(QString());
        membership->setText(QCoreApplication::translate("AdminRemoveMember", "Membership", nullptr));
        pushButton_2->setText(QCoreApplication::translate("AdminRemoveMember", "Logout", nullptr));
        back->setText(QCoreApplication::translate("AdminRemoveMember", "Back", nullptr));
        plainTextEdit_9->setPlainText(QString());
        plainTextEdit_10->setPlainText(QCoreApplication::translate("AdminRemoveMember", "Search for Member", nullptr));
        plainTextEdit_11->setPlainText(QCoreApplication::translate("AdminRemoveMember", "Enter member details.", nullptr));
        firstName->setText(QCoreApplication::translate("AdminRemoveMember", "Enter First Name", nullptr));
        firstName->setPlaceholderText(QCoreApplication::translate("AdminRemoveMember", "Enter title", nullptr));
        label_2->setText(QCoreApplication::translate("AdminRemoveMember", "Name", nullptr));
        label_3->setText(QCoreApplication::translate("AdminRemoveMember", "Surname", nullptr));
        lastName->setText(QCoreApplication::translate("AdminRemoveMember", "Enter Last Name", nullptr));
        lastName->setPlaceholderText(QCoreApplication::translate("AdminRemoveMember", "Enter author", nullptr));
        lisNum->setText(QCoreApplication::translate("AdminRemoveMember", "Account Number", nullptr));
        lisNum->setPlaceholderText(QCoreApplication::translate("AdminRemoveMember", "Enter author", nullptr));
        label_4->setText(QCoreApplication::translate("AdminRemoveMember", "LIS Access Number", nullptr));
        pushButton->setText(QCoreApplication::translate("AdminRemoveMember", "Remove Member", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AdminRemoveMember: public Ui_AdminRemoveMember {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINREMOVEMEMBER_H
