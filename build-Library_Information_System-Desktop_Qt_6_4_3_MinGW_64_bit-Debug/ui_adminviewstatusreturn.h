/********************************************************************************
** Form generated from reading UI file 'adminviewstatusreturn.ui'
**
...
#ifndef UI_ADMINVIEWSTATUSRETURN_H
#define UI_ADMINVIEWSTATUSRETURN_H
...
class Ui_AdminViewStatusReturn
{
public:
    ...
    void setupUi(QMainWindow *AdminViewStatusReturn)
    {
        if (AdminViewStatusReturn->objectName().isEmpty())
            AdminViewStatusReturn->setObjectName("AdminViewStatusReturn");
        AdminViewStatusReturn->resize(1020, 704);
        centralwidget = new QWidget(AdminViewStatusReturn);
...
"border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0.034, y2:0.017, stop:0 rgba(255, 255, 255, 255));"));
        ...
        AdminViewStatusReturn->setCentralWidget(centralwidget);
        menubar = new QMenuBar(AdminViewStatusReturn);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 1020, 21));
        AdminViewStatusReturn->setMenuBar(menubar);
        statusbar = new QStatusBar(AdminViewStatusReturn);
        statusbar->setObjectName("statusbar");
        AdminViewStatusReturn->setStatusBar(statusbar);

        retranslateUi(AdminViewStatusReturn);

        QMetaObject::connectSlotsByName(AdminViewStatusReturn);
    } // setupUi

    void retranslateUi(QMainWindow *AdminViewStatusReturn)
    {
        AdminViewStatusReturn->setWindowTitle(QCoreApplication::translate("AdminViewStatusReturn", "MainWindow", nullptr));
        menuPanel->setTitle(QString());
        logo->setText(QString());
        label_8->setText(QString());
        membershipButton->setText(QCoreApplication::translate("AdminViewStatusReturn", "Membership", nullptr));
        label->setText(QCoreApplication::translate("AdminViewStatusReturn", "Admin Menu", nullptr));
        label_7->setText(QString());
        status->setText(QCoreApplication::translate("AdminViewStatusReturn", "View Status", nullptr));
        label_6->setText(QString());
        manageBooksButton->setText(QCoreApplication::translate("AdminViewStatusReturn", "Manage Books", nullptr));
        label_5->setText(QString());
        catalogueButton->setText(QCoreApplication::translate("AdminViewStatusReturn", "Catalogue", nullptr));
        back->setText(QCoreApplication::translate("AdminViewStatusReturn", "Back", nullptr));
        logout->setText(QCoreApplication::translate("AdminViewStatusReturn", "Logout", nullptr));
        plainTextEdit_9->setPlainText(QString());
        plainTextEdit_10->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "Returned Books", nullptr));
        plainTextEdit_11->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "A list of all returned books. Please select one to add back to the catalogue", nullptr));
        ...
        plainTextEdit->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "Different Winter\n"
"Mia Jackson", nullptr));
        plainTextEdit_2->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "Comic Book\n"
"Greg Harold", nullptr));
        plainTextEdit_3->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "Learn Play\n"
"Author", nullptr));
        plainTextEdit_4->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "Book\n"
"Author", nullptr));
        plainTextEdit_5->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "Soft Cover\n"
"Ben Scott", nullptr));
        plainTextEdit_6->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "Looks Good on Paper\n"
"Patricia Kim", nullptr));
        plainTextEdit_7->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "New Educators\n"
"Marissa Pullman", nullptr));
        plainTextEdit_8->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "The Bike Guy\n"
"Emma Mayers", nullptr));
        plainTextEdit_12->setPlainText(QCoreApplication::translate("AdminViewStatusReturn", "Snow at Sunset\n"
...
namespace Ui {
    class AdminViewStatusReturn: public Ui_AdminViewStatusReturn {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINVIEWSTATUSRETURN_H
