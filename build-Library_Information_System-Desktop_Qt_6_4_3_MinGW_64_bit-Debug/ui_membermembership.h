/********************************************************************************
** Form generated from reading UI file 'membermembership.ui'
**
...
#ifndef UI_MEMBERMEMBERSHIP_H
#define UI_MEMBERMEMBERSHIP_H
...
public:
    ...
    void setupUi(QDialog *MemberMembership)
    {
        if (MemberMembership->objectName().isEmpty())
            MemberMembership->setObjectName("MemberMembership");
        MemberMembership->resize(1019, 670);
        frame = new QFrame(MemberMembership);
        frame->setObjectName("frame");
        frame->setGeometry(QRect(0, 0, 1021, 648));
...
"border-radius: 10px;"));
        ...
        plainTextEdit_10->setGeometry(QRect(30, 40, 321, 41));
...
"font-weight: bold;"));
        ...
        label_3->setGeometry(QRect(0, 120, 121, 16));
...
"border-radius: 5px;\n"
"background: rgb(235, 235, 235);"));
        request_button = new QPushButton(frame_9);
        request_button->setObjectName("request_button");
        request_button->setGeometry(QRect(0, 230, 231, 31));
        request_button->setContextMenuPolicy(Qt::NoContextMenu);
...
"	color: rgb(106, 146, 255);\n"
"}"));
        request_button->setAutoDefault(false);

        retranslateUi(MemberMembership);

        QMetaObject::connectSlotsByName(MemberMembership);
    } // setupUi

    void retranslateUi(QDialog *MemberMembership)
    {
        MemberMembership->setWindowTitle(QCoreApplication::translate("MemberMembership", "Dialog", nullptr));
        menuPanel->setTitle(QString());
        logo->setText(QString());
        pushButton_2->setText(QCoreApplication::translate("MemberMembership", "Logout", nullptr));
        back->setText(QCoreApplication::translate("MemberMembership", "Back", nullptr));
        label_5->setText(QString());
        catalogue->setText(QCoreApplication::translate("MemberMembership", "Catalogue", nullptr));
        label_6->setText(QString());
        manageBooks->setText(QCoreApplication::translate("MemberMembership", "Overdue", nullptr));
        label_7->setText(QString());
        status->setText(QCoreApplication::translate("MemberMembership", "Pre-Booked", nullptr));
        label_8->setText(QString());
        membership->setText(QCoreApplication::translate("MemberMembership", "Membership", nullptr));
        label->setText(QCoreApplication::translate("MemberMembership", "Member Menu", nullptr));
        plainTextEdit_9->setPlainText(QString());
        plainTextEdit_10->setPlainText(QCoreApplication::translate("MemberMembership", "Request Detail Change", nullptr));
        plainTextEdit_11->setPlainText(QCoreApplication::translate("MemberMembership", "Please enter your new detail to request a chnage", nullptr));
        lineEdit_title->setText(QCoreApplication::translate("MemberMembership", "Name & Surname", nullptr));
        lineEdit_title->setPlaceholderText(QCoreApplication::translate("MemberMembership", "Enter title", nullptr));
        label_2->setText(QCoreApplication::translate("MemberMembership", "Full Name", nullptr));
        label_3->setText(QCoreApplication::translate("MemberMembership", "Contact Number", nullptr));
        lineEdit_author->setText(QCoreApplication::translate("MemberMembership", "Number", nullptr));
        lineEdit_author->setPlaceholderText(QCoreApplication::translate("MemberMembership", "Enter author", nullptr));
        request_button->setText(QCoreApplication::translate("MemberMembership", "Request", nullptr));
    } // retranslateUi

};

namespace Ui {
    class MemberMembership: public Ui_MemberMembership {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MEMBERMEMBERSHIP_H
