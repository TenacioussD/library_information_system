/********************************************************************************
** Form generated from reading UI file 'memberpreorder.ui'
**
...
#ifndef UI_MEMBERPREORDER_H
#define UI_MEMBERPREORDER_H
...
public:
    ...
    QTableView *preOrderView;

    void setupUi(QDialog *MemberPreOrder)
    {
        if (MemberPreOrder->objectName().isEmpty())
            MemberPreOrder->setObjectName("MemberPreOrder");
        MemberPreOrder->resize(1019, 670);
        frame = new QFrame(MemberPreOrder);
        frame->setObjectName("frame");
        frame->setGeometry(QRect(0, 0, 1021, 641));
...
"}"));
        ...
        status_1->setStyleSheet(QString::fromUtf8("background: rgb(240, 240, 240);\n"
"border-radius: 5px;"));
...
"font-size: 13px;"));
        ...
        preOrderView = new QTableView(frame);
        preOrderView->setObjectName("preOrderView");
        preOrderView->setGeometry(QRect(300, 210, 641, 391));

        retranslateUi(MemberPreOrder);

        QMetaObject::connectSlotsByName(MemberPreOrder);
    } // setupUi

    void retranslateUi(QDialog *MemberPreOrder)
    {
        MemberPreOrder->setWindowTitle(QCoreApplication::translate("MemberPreOrder", "Dialog", nullptr));
        menuPanel->setTitle(QString());
        logo->setText(QString());
        label_5->setText(QString());
        catalogue->setText(QCoreApplication::translate("MemberPreOrder", "Catalogue", nullptr));
        label_6->setText(QString());
        manageBooks->setText(QCoreApplication::translate("MemberPreOrder", "Overdue", nullptr));
        label_7->setText(QString());
        status->setText(QCoreApplication::translate("MemberPreOrder", "Pre-Booked", nullptr));
        label_8->setText(QString());
        membership->setText(QCoreApplication::translate("MemberPreOrder", "Membership", nullptr));
        label->setText(QCoreApplication::translate("MemberPreOrder", "Member Menu", nullptr));
        back->setText(QCoreApplication::translate("MemberPreOrder", "Back", nullptr));
        logout->setText(QCoreApplication::translate("MemberPreOrder", "Logout", nullptr));
        plainTextEdit_2->setPlainText(QString());
        plainTextEdit_3->setPlainText(QCoreApplication::translate("MemberPreOrder", "View Pre Ordered Books", nullptr));
        plainTextEdit_4->setPlainText(QCoreApplication::translate("MemberPreOrder", "Here you view your pre ordered books", nullptr));
    } // retranslateUi

};

namespace Ui {
    class MemberPreOrder: public Ui_MemberPreOrder {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MEMBERPREORDER_H
