/********************************************************************************
** Form generated from reading UI file 'adminviewallmembers.ui'
**
...
#ifndef UI_ADMINVIEWALLMEMBERS_H
#define UI_ADMINVIEWALLMEMBERS_H
...
public:
    ...
    void setupUi(QDialog *AdminViewAllMembers)
    {
        if (AdminViewAllMembers->objectName().isEmpty())
            AdminViewAllMembers->setObjectName("AdminViewAllMembers");
        AdminViewAllMembers->resize(1019, 670);
        frame = new QFrame(AdminViewAllMembers);
...
"background: transparent;"));
        ...
        tableView->setGeometry(QRect(290, 180, 641, 421));
        tableView->setStyleSheet(QString::fromUtf8("font: 9pt \"Segoe UI\";"));

        retranslateUi(AdminViewAllMembers);

        QMetaObject::connectSlotsByName(AdminViewAllMembers);
    } // setupUi

    void retranslateUi(QDialog *AdminViewAllMembers)
    {
        AdminViewAllMembers->setWindowTitle(QCoreApplication::translate("AdminViewAllMembers", "Dialog", nullptr));
        menuPanel->setTitle(QString());
        logo->setText(QString());
        plainTextEdit_6->setPlainText(QCoreApplication::translate("AdminViewAllMembers", "Admin Menu", nullptr));
        label_5->setText(QString());
        catalogue->setText(QCoreApplication::translate("AdminViewAllMembers", "Catalogue", nullptr));
        label_6->setText(QString());
        manageBooks->setText(QCoreApplication::translate("AdminViewAllMembers", "Manage Books", nullptr));
        label_7->setText(QString());
        status->setText(QCoreApplication::translate("AdminViewAllMembers", "View Status", nullptr));
        label_8->setText(QString());
        membership->setText(QCoreApplication::translate("AdminViewAllMembers", "Membership", nullptr));
        pushButton_2->setText(QCoreApplication::translate("AdminViewAllMembers", "Logout", nullptr));
        back->setText(QCoreApplication::translate("AdminViewAllMembers", "Back", nullptr));
        plainTextEdit_9->setPlainText(QString());
        plainTextEdit_10->setPlainText(QCoreApplication::translate("AdminViewAllMembers", "All Members", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AdminViewAllMembers: public Ui_AdminViewAllMembers {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINVIEWALLMEMBERS_H
