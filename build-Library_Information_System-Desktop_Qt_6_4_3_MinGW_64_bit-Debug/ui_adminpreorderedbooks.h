/********************************************************************************
** Form generated from reading UI file 'adminpreorderedbooks.ui'
**
...
#ifndef UI_ADMINPREORDEREDBOOKS_H
#define UI_ADMINPREORDEREDBOOKS_H
...
public:
    ...
    void setupUi(QMainWindow *AdminPreOrderedBooks)
    {
        if (AdminPreOrderedBooks->objectName().isEmpty())
            AdminPreOrderedBooks->setObjectName("AdminPreOrderedBooks");
        AdminPreOrderedBooks->resize(1014, 708);
        centralwidget = new QWidget(AdminPreOrderedBooks);
...
"border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0.034, y2:0.017, stop:0 rgba(255, 255, 255, 255));"));
        ...
        AdminPreOrderedBooks->setCentralWidget(centralwidget);
        menubar = new QMenuBar(AdminPreOrderedBooks);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 1014, 21));
        AdminPreOrderedBooks->setMenuBar(menubar);
        statusbar = new QStatusBar(AdminPreOrderedBooks);
        statusbar->setObjectName("statusbar");
        AdminPreOrderedBooks->setStatusBar(statusbar);

        retranslateUi(AdminPreOrderedBooks);

        QMetaObject::connectSlotsByName(AdminPreOrderedBooks);
    } // setupUi

    void retranslateUi(QMainWindow *AdminPreOrderedBooks)
    {
        AdminPreOrderedBooks->setWindowTitle(QCoreApplication::translate("AdminPreOrderedBooks", "MainWindow", nullptr));
        menuPanel->setTitle(QString());
        logo->setText(QString());
        label_8->setText(QString());
        membershipButton->setText(QCoreApplication::translate("AdminPreOrderedBooks", "Membership", nullptr));
        label->setText(QCoreApplication::translate("AdminPreOrderedBooks", "Admin Menu", nullptr));
        label_7->setText(QString());
        status->setText(QCoreApplication::translate("AdminPreOrderedBooks", "View Status", nullptr));
        label_6->setText(QString());
        manageBooksButton->setText(QCoreApplication::translate("AdminPreOrderedBooks", "Manage Books", nullptr));
        label_5->setText(QString());
        catalogueButton->setText(QCoreApplication::translate("AdminPreOrderedBooks", "Catalogue", nullptr));
        back->setText(QCoreApplication::translate("AdminPreOrderedBooks", "Back", nullptr));
        logout->setText(QCoreApplication::translate("AdminPreOrderedBooks", "Logout", nullptr));
        plainTextEdit_9->setPlainText(QString());
        plainTextEdit_10->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "Pre Ordered Books", nullptr));
        plainTextEdit_11->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "A list of all pre ordered books. Please select one to view membership information.", nullptr));
        ...
        plainTextEdit->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "Different Winter\n"
"Mia Jackson", nullptr));
        plainTextEdit_2->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "Comic Book\n"
"Greg Harold", nullptr));
        plainTextEdit_3->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "Learn Play\n"
"Author", nullptr));
        plainTextEdit_4->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "Book\n"
"Author", nullptr));
        plainTextEdit_5->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "Soft Cover\n"
"Ben Scott", nullptr));
        plainTextEdit_6->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "Looks Good on Paper\n"
"Patricia Kim", nullptr));
        plainTextEdit_7->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "New Educators\n"
"Marissa Pullman", nullptr));
        plainTextEdit_8->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "The Bike Guy\n"
"Emma Mayers", nullptr));
        plainTextEdit_12->setPlainText(QCoreApplication::translate("AdminPreOrderedBooks", "Snow at Sunset\n"
...
namespace Ui {
    class AdminPreOrderedBooks: public Ui_AdminPreOrderedBooks {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINPREORDEREDBOOKS_H
