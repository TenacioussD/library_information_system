/********************************************************************************
** Form generated from reading UI file 'admineditmember.ui'
**
...
#ifndef UI_ADMINEDITMEMBER_H
#define UI_ADMINEDITMEMBER_H
...
public:
    ...
    void setupUi(QDialog *AdminEditMember)
    {
        if (AdminEditMember->objectName().isEmpty())
            AdminEditMember->setObjectName("AdminEditMember");
        AdminEditMember->resize(1019, 670);
        frame = new QFrame(AdminEditMember);
...
"font-weight: bold;"));
        ...
        retranslateUi(AdminEditMember);

        QMetaObject::connectSlotsByName(AdminEditMember);
    } // setupUi

    void retranslateUi(QDialog *AdminEditMember)
    {
        AdminEditMember->setWindowTitle(QCoreApplication::translate("AdminEditMember", "Dialog", nullptr));
        menuPanel->setTitle(QString());
        logo->setText(QString());
        plainTextEdit_6->setPlainText(QCoreApplication::translate("AdminEditMember", "Admin Menu", nullptr));
        label_5->setText(QString());
        catalogue->setText(QCoreApplication::translate("AdminEditMember", "Catalogue", nullptr));
        label_6->setText(QString());
        manageBooks->setText(QCoreApplication::translate("AdminEditMember", "Manage Books", nullptr));
        label_7->setText(QString());
        status->setText(QCoreApplication::translate("AdminEditMember", "View Status", nullptr));
        label_8->setText(QString());
        membership->setText(QCoreApplication::translate("AdminEditMember", "Membership", nullptr));
        pushButton_2->setText(QCoreApplication::translate("AdminEditMember", "Logout", nullptr));
        back->setText(QCoreApplication::translate("AdminEditMember", "Back", nullptr));
        plainTextEdit_9->setPlainText(QString());
        plainTextEdit_10->setPlainText(QCoreApplication::translate("AdminEditMember", "Edit Member", nullptr));
        plainTextEdit_11->setPlainText(QCoreApplication::translate("AdminEditMember", "Start the process by add exsiting user information.", nullptr));
        firstName->setText(QCoreApplication::translate("AdminEditMember", "Enter First Name", nullptr));
        firstName->setPlaceholderText(QCoreApplication::translate("AdminEditMember", "Enter title", nullptr));
        label_2->setText(QCoreApplication::translate("AdminEditMember", "Name", nullptr));
        label_3->setText(QCoreApplication::translate("AdminEditMember", "Surname", nullptr));
        lastName->setText(QCoreApplication::translate("AdminEditMember", "Enter Last Name", nullptr));
        lastName->setPlaceholderText(QCoreApplication::translate("AdminEditMember", "Enter author", nullptr));
        addMemberBut->setText(QCoreApplication::translate("AdminEditMember", "Search User", nullptr));
        lisNum->setText(QCoreApplication::translate("AdminEditMember", "Account Number", nullptr));
        lisNum->setPlaceholderText(QCoreApplication::translate("AdminEditMember", "Enter author", nullptr));
        label_4->setText(QCoreApplication::translate("AdminEditMember", "LIS Access Number", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AdminEditMember: public Ui_AdminEditMember {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINEDITMEMBER_H
